...
public interface IQueryMapper {
	...
	public static final String APPLY = "INSERT INTO Application (Application_id,full_name,date_of_birth,highest_qualification,marks_obtained,goals,email_id,Scheduled_program_id,status,Date_Of_Interview,address)	VALUES(Application_id.nextval,?,?,?,?,?,?,?,?,?,?)";
